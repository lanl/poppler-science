...
#include "GfxState.h"
#include "Annot.h"
//#include "TextOutputDev.h" <-- Why does Page.cc need to include TextOutputDev.h?
#include "Form.h"
#include "Error.h"
#include "Page.h"
#include "Catalog.h"
...
PDFRectangle PDFRectangle::rotate_counter_clockwise(const int m_rot) const
    {
        if(m_rot == 0){
        ...
        // The negative signs are added because we are rotating about the origin of the coordinate system
        switch(m_rot){
            case 1:
                ret.x1 = y1;
                ret.y1 = -x2;
            ...
            case 3:
                ...
                break;
            default:
                error(errInternal, -1, ":PDFRectangle::rotate_counter_clockwise: Invalid rotation");
        };
