...
public:
    ...
    double& xMin(){return x1;};
    double& yMin(){return y1;};
    double& xMax(){return x2;};
    double& yMax(){return y2;};

    double xMin() const {return x1;};
    double yMin() const {return y1;};
    double xMax() const {return x2;};
    double yMax() const {return y2;};
    ...
    PDFRectangle& operator |=(const PDFRectangle &m_rhs){
